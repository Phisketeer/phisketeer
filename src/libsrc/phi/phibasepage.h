...
public:
    ...
    enum Flag { FNone=0x0, FUseOwnPalette=0x1, FApplicationMode=0x2, FPageLeftAlign=0x4,
        ...
        FClient=0x100000, FHasPhiLangItem=0x200000, FVersion1x=0x400000,
        FDirtyHtmlHeader=0x800000 }; // quint32
...
private:
    ...
    mutable QHash <PHIWID, QByteArray> _headerExtensions, _scriptExtensions;
