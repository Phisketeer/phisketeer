...
public:
    ...
    static QImage reflectedImage( const QImage &img, qreal off, qreal size, QRectF &br );
    static QImage colorizedImage( const QImage &img, const QColor &c, qreal strength, QRectF &br );
    static QImage dropShadowedImage( const QImage &img, const QColor &color,
        qreal radius, qreal xOff, qreal yOff, QRectF &br );
    static QImage bluredImage( const QImage &img, qreal radius, QRectF &br );
