...
*/
#ifndef PHISSERVERREQUEST_H
#define PHISSERVERREQUEST_H
#include <QObject>
...
class PHISServerRequest : public QObject, public PHIRequest
{
    Q_OBJECT

public:
    explicit PHISServerRequest( const PHISServerRec *server, PHIResponseRec *resp, QObject *parent );
    virtual ~PHISServerRequest() {}
...
private:
    const PHISServerRec *_server;
};

#endif // PHISSERVERREQUEST_H
