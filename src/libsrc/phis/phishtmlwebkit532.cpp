...
PHISHtmlWebKit532::PHISHtmlWebKit532( const PHISRequest *req, const PHIBasePage *page )
...
PHISHtmlWebKit532::~PHISHtmlWebKit532()
{
}

QRect PHISHtmlWebKit532::adjustButtonSize() const
{
    if ( _isMacOSX ) {
        //if ( _isSafari ) return QRect( 1, 1, -2, -2 );
        return QRect( 1, 1, -2, -2 );
    }
    return QRect( 0, 0, 0, 0 );
}

QRect PHISHtmlWebKit532::adjustLineEditSize() const
{
    if ( _isMacOSX ) return QRect( 0, 0, -6, -6 );
    return QRect( 0, 0, -2, -2 );
}

QRect PHISHtmlWebKit532::adjustMultiLineEditSize() const
{
    if ( _isMacOSX ) return QRect( 0, 0, -6, -6 );
    return QRect( 0, 0, -2, -2 );
}

QRect PHISHtmlWebKit532::adjustSelectSize() const
{
    if ( _isMacOSX ) return QRect( 0, 0, 0, 0 );
    return QRect( 0, 0, 0, static_cast<int>(-_it->height()) );
}

QRect PHISHtmlWebKit532::adjustFileButton() const
{
    if ( _isMacOSX ) return QRect( 2, 2, -4, -4 );
    return QRect( 0, 0, 0, static_cast<int>(-_it->height()) );
}

qint8 PHISHtmlWebKit532::adjustDateEditButtonSpace() const
{
    if ( _isMacOSX ) return static_cast<qint8>( 0 );
    return static_cast<qint8>(-4);
}

QByteArray PHISHtmlWebKit532::phisEngine() const
{
    static QByteArray arr="Phis "+PHIS::libVersion().toLatin1()+"/WebKit 532";
    return arr;
}
...
void PHISHtmlWebKit532::dateEdit() const
{
