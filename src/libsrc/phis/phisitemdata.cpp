...
PHISItemData::PHISItemData( QObject *parent )
...
{
/*
    qDebug( "PHISItemData::PHISItemData()" );
...
PHISItemData& PHISItemData::operator =( const PHISItemData &d )
{
...
PHISItemData::PHISItemData( const PHISItemData &d )
...
QByteArray PHISItemData::save( PHIItem::Properties p ) const
{
    QByteArray arr;
...
void PHISItemData::setGradient( QLinearGradient g )
{
...
void PHISItemData::setGradient( QConicalGradient g )
{
...
void PHISItemData::setGradient( QRadialGradient g )
{
...
QGradient PHISItemData::gradient() const
{
    QGradient g;
...
QLinearGradient PHISItemData::linearGradient() const
{
...
QConicalGradient PHISItemData::conicalGradient() const
{
...
QRadialGradient PHISItemData::radialGradient() const
{
...
void PHISItemData::load( PHIItem::Properties p, const QByteArray &data )
{
    QByteArray arr=data;
