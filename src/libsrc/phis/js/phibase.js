...
function PhiItem( obj ) {
  ...
  this.fadeIn=function( s, d, o, e ) {
    if ( s===undefined || s===0 ) {if ( this.opacity()>=(o?o:1) ) return this;
    } else j(id).css({opacity:0});
    setTimeout( function(){
  ...
  this.fadeOut=function( s, d, o, e ) {
    if ( s===undefined || s===0 ) {if ( this.opacity()<=(o?o:0) ) return this;
    } else j(id).css({opacity:1});
    setTimeout( function(){
  ...
  this.scale=function(s) { if(s===undefined)return j(id).css('scale');j(id).css('scale',s); return this;}
  this.scaleTo=function(a,d,e){j(id).animate({scale:a},{queue:false,duration:(d?d:1000),easing:e});return this;};
...
$$slideShow=function( s, c ){
    var j=jQuery;
    for (i=1;i<c;i++) {$(s+'_phi_'+i).opacity(0);}
    var o=$(s);
