...
*/
#ifndef PHISITEMDATA_H
#define PHISITEMDATA_H
...
class PHISEXPORT PHISItemData : public QObject
{
    Q_OBJECT

public:
    PHISItemData( QObject *parent=0 );
    virtual ~PHISItemData();
    PHISItemData& operator =( const PHISItemData& );
    PHISItemData( const PHISItemData& );
    ...
    inline quint16 maxSize() const {
        return _variants.value( PHIItem::DMaxSize, PHI::maxLength() ).value<quint16>(); }
...
Q_DECLARE_METATYPE( PHISItemData )

#endif // PHISITEMDATA_H
