...
[Files]
Source: phi2.dll; DestDir: {app}\bin; Components: core; Flags: 32bit replacesameversion restartreplace uninsnosharedfileprompt
Source: phia2.dll; DestDir: {app}\bin; Components: core; Flags: 32bit replacesameversion restartreplace uninsnosharedfileprompt
...
Source: msvcr110.dll; DestDir: {app}\bin; Components: core; Flags: 32bit uninsnosharedfileprompt
Source: msvcp110.dll; DestDir: {app}\bin; Components: core; Flags: 32bit uninsnosharedfileprompt
...
Source: Qt5Positioning.dll; DestDir: {app}\bin; Components: core; Flags: 32bit restartreplace uninsnosharedfileprompt
Source: Qt5Xml.dll; DestDir: {app}\bin; Components: core; Flags: 32bit restartreplace uninsnosharedfileprompt
Source: Qt5Sensors.dll; DestDir: {app}\bin; Components: core; Flags: 32bit restartreplace uninsnosharedfileprompt
...
Source: d3dcompiler_46.dll; DestDir: {app}\bin; Components: core; Flags: 32bit restartreplace uninsnosharedfileprompt
...
Source: icudt51.dll; DestDir: {app}\bin; Components: core; Flags: 32bit replacesameversion uninsnosharedfileprompt
Source: icuin51.dll; DestDir: {app}\bin; Components: core; Flags: 32bit replacesameversion uninsnosharedfileprompt
Source: icuuc51.dll; DestDir: {app}\bin; Components: core; Flags: 32bit replacesameversion uninsnosharedfileprompt
...
Source: items\*.dll; DestDir: {app}\bin\plugins\items; Components: core; Flags: 32bit replacesameversion
...
Source: phis2.dll; DestDir: {app}\bin; Components: server editor; Flags: 32bit replacesameversion restartreplace uninsnosharedfileprompt
...
Source: mod_phi2.dll; DestDir: {code:GetApacheDir}\modules; Components: apache; DestName: mod_phi.so; Flags: replacesameversion 32bit
...
Name: {group}\Phis configuration; Filename: {app}\bin\PhisConf.exe; WorkingDir: {app}; IconFilename: {app}\bin\PhisConf.exe; Flags: createonlyiffileexists useapppaths; Components: server
...
Root: HKLM; Subkey: SOFTWARE\Phisketeer\phis; ValueName: RootDir; ValueType: string; ValueData: {app}; Components: server
...
;Root: HKLM; Subkey: SOFTWARE\MozillaPlugins\@phisketeer.org/npphi,version=2.0.0; ValueType: none; Components: plugin; Flags: uninsdeletekey deletekey
;Root: HKLM; Subkey: SOFTWARE\MozillaPlugins\@phisketeer.org/npphi,version=2.0.0; ValueName: Path; ValueType: string; ValueData: {app}\bin\npphiplugin1.dll; Components: plugin
;Root: HKLM; Subkey: SOFTWARE\MozillaPlugins\@phisketeer.org/npphi,version=2.0.0; ValueName: Description; ValueType: string; ValueData: Phi plug-in V2.0.0; Components: plugin
;Root: HKLM; Subkey: SOFTWARE\MozillaPlugins\@phisketeer.org/npphi,version=2.0.0; ValueName: Vendor; ValueType: string; ValueData: Phisketeer; Components: plugin
;Root: HKLM; Subkey: SOFTWARE\MozillaPlugins\@phisketeer.org/npphi,version=2.0.0\MimeTypes\application/x-phi; ValueType: none; Components: plugin; Flags: uninsdeletekey deletekey
;Root: HKLM; Subkey: SOFTWARE\MozillaPlugins\@phisketeer.org/npphi,version=2.0.0\MimeTypes\application/x-phi; ValueName: Description; ValueType: string; ValueData: Phi plug-in; Components: plugin
;Root: HKLM; Subkey: SOFTWARE\MozillaPlugins\@phisketeer.org/npphi,version=2.0.0\MimeTypes\application/x-phi; ValueName: Suffixes; ValueType: string; ValueData: phi; Components: plugin
...
Root: HKCR; Subkey: PhisketeerArtephis\DefaultIcon; ValueType: string; ValueData: {app}\bin\Artephis.exe,0; Components: editor
...
Root: HKCU; Subkey: SOFTWARE\Phisketeer\Artephis; ValueType: string; Flags: createvalueifdoesntexist; Components: editor; ValueName: BaseDir; ValueData: {code:GetDataDir}
...
begin
	...
	if RegQueryStringValue(HKLM, 'SOFTWARE\Phisketeer\phis\default', 'BaseDir', Buffer) then
		DataDirPage.Values[0] := Buffer
	else
		DataDirPage.Values[0] := ExpandConstant( '{pf}\Phisketeer\data' );
